...
from methods.utils.crops_forward_utils import GetAttentionMaskwithFastVandTextMask
...
def forward(
    ...
    ## Should be always true for fast_v and text_mask to work
